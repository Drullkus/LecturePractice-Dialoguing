class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('tinfoil_cat', 'img/tinfoil_cat.png');

        // load bitmap font
        this.load.bitmapFont('gem_font', 'font/gem.png', 'font/gem.xml');
        this.load.bitmapFont('gridova_font', 'font/gridova.png', 'font/gridova.xml');
    }

    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'gridova_font', 'A MIDSUMMER NIGHT\'S DREAM', 32 * 1.5).setOrigin(0.5);
        this.add.bitmapText(centerX, centerY + 16, 'gridova_font', 'Press SPACE to start', 24 * 1.5).setOrigin(0.5);
